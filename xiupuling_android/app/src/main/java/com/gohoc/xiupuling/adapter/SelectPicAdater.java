...
public class SelectPicAdater extends RecyclerView.Adapter<SelectPicAdater.MyViewHolder> {

    private Context context;
    private BusinessBean businessBean;
    private OnItemClickLitener onItemClickLitener;

    public SelectPicAdater(Context context, BusinessBean businessBean) {
