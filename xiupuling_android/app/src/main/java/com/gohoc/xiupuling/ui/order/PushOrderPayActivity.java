...
public class PushOrderPayActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_push_order_pay);
    ...
    private void initPay() {
        try {
            ...
            orderNameV.setText(resultBean.getData().getTradename() + "");
                ...
                switch (msg.what) {
                    case SDK_PAY_FLAG: {
                        ...
                        if (payResult.getResultStatus().equals("9000")) {
                            startActivity(new Intent(PushOrderPayActivity.this, PushOrderPayReslutActivity.class)
                                    .putExtra("resultBean", resultBean)
                                    .putExtra("pushNormlBean", pushNormlBean)

                            );
                        } else
                            Utils.toast(PushOrderPayActivity.this, payResult.getMemo());
                        break;
                    }
                    default:
                        break;
    ...
    private void initorder(String refno) {
        RxRetrofitClient.getInstance(this).initorder(refno, new Observer<VCodeBenan>() {
            ...
            public void onError(Throwable e) {
                Utils.toast(PushOrderPayActivity.this, "订单初始化失败");
                try {
                    throw e;
            ...
            public void onNext(VCodeBenan vCodeBenan) {
                if (vCodeBenan.getCode() == 1) {
                    ...
                    Runnable payRunnable = new Runnable() {
                        ...
                        public void run() {
                            // 构造PayTask 对象
                            PayTask alipay = new PayTask(PushOrderPayActivity.this);
                            // 调用支付接口，获取支付结果
                    ...
                    Utils.toast(PushOrderPayActivity.this, vCodeBenan.getMessage() + "");
            }
        });
    }
    ...
    private void kqinitorder(String refno) {
        RxRetrofitClient.getInstance(this).kqinitorder(refno, new Observer<VCodeBenan>() {
            ...
            public void onNext(VCodeBenan vCodeBenan) {
                if (vCodeBenan.getCode() == 1) {
                    startActivity(new Intent(PushOrderPayActivity.this, PayWebViewActivity.class).putExtra("url", vCodeBenan.getData()).putExtra("title", "快钱支付"));
                } else
                    Utils.toast(PushOrderPayActivity.this, vCodeBenan.getMessage() + "");
            }
        });
        ...
        RxRetrofitClient.getInstance(this).unifiedorder(refno, new Observer<WxPayBean>() {
            ...
            public void onNext(WxPayBean wxPayBean) {
                if (wxPayBean.getCode() == 1) {
                    ...
                    Utils.toast(PushOrderPayActivity.this, wxPayBean.getMessage());
            }
        });
    }
