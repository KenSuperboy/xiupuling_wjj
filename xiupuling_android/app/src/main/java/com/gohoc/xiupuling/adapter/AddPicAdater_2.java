...
public class AddPicAdater_2 extends DragAdapater<AddPicAdater_2.MyViewHolder> implements Constant {
    ...
    public AddPicAdater_2(Context context, List<PicBean> picBeanList) {
