...
public class ToBeDesignerActivity2 extends BasicActivity {
    ...
    private Integer[] pics = {R.mipmap.design_tips_new_icon_1, R.mipmap.identity_design_active};
    private static int TERMINALER_REQUEST_RESULT = 1000;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_to_be_designer2);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.save_button_ll:
                startActivityForResult(new Intent(ToBeDesignerActivity2.this,ToBeDesignerActivity3.class),TERMINALER_REQUEST_RESULT);
                break;
        }
    }
