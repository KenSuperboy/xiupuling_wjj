...
public class AddPicAdater_3 extends DragAdapater<AddPicAdater_3.MyViewHolder> implements Constant {
    ...
    public AddPicAdater_3(Context context, List<PicBean> picBeanList) {
