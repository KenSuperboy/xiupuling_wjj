...
* 作品组合包排序
* */
public class CombinationPaixuAdapter extends RecyclerView.Adapter<CombinationPaixuAdapter.Holder> implements OnItemCallbackListener {
	private List<CombinationListDetailBean.DataBean> testItems;
	...
	public CombinationPaixuAdapter(Context context,List<CombinationListDetailBean.DataBean> myTestItems) {
	...
	public List<CombinationListDetailBean.DataBean> getDataList()
	{
		return testItems;
	}
	...
	class Holder extends RecyclerView.ViewHolder {
		TextView tv_name,tv_length,tv_number;
