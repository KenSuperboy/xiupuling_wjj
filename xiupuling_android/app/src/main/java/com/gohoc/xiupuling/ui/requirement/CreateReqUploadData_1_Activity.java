...
* 上传海报  ：图片（一张图片）  拍照   音频
* */
public class CreateReqUploadData_1_Activity extends BasicActivity implements OnUploadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                                             ...
                                             public void onPrepared(MediaPlayer mp) {
                                                 ...
                                                 //FixMe 获取屏幕的宽度
                                                 DisplayMetrics display = CreateReqUploadData_1_Activity.this.getResources().getDisplayMetrics();
    ...
    private void initRv() {
        ...
        if (picList.size() == 0) {
            ...
            picList.add(picBean);
        } else if (picList.size() < 2 && mType == 1) {
            PicBean picBean = new PicBean();
            picBean.setStatus(100);
            picList.add(picBean);
        }
        LogUtil.d("设置前的长度："+picList.size());
        recyclerView.setLayoutManager(new GridLayoutManager(CreateReqUploadData_1_Activity.this, 2));
        recyclerView.addItemDecoration(new SimplePaddingDecoration(this));
        //设置adapter
        addPicAdater = new AddPicAdater_1(CreateReqUploadData_1_Activity.this, picList);
        ...
        recyclerView.addOnItemTouchListener(new OnRecyclerViewItemClickListener(recyclerView) {
            ...
            public void onLoncClick(RecyclerView.ViewHolder viewHolder) {
                ...
                if (viewHolder.getLayoutPosition() != picList.size() - 1) {
                    ...
                    VibratorUtil.Vibrate(CreateReqUploadData_1_Activity.this, 60);//ms
                }
            }
                ...
                ThreadTask.getInstance().executorDBThread(new Runnable() {
                    ...
                    public void run() {
                        for (ImageItem imageItem : images) {
                            ...
                            imageItem.path = com.gohoc.xiupuling.utils.ImageUtils.compress(CreateReqUploadData_1_Activity.this, imageItem.path);
    ...
    private void uploadFile(final PicBean picBean, final int potions) {
        RxRetrofitClient.getInstance(CreateReqUploadData_1_Activity.this).getUploadToken(new Observer<VCodeBenan>() {
            @Override
            ...
            public void onError(Throwable e) {
                Utils.toast(CreateReqUploadData_1_Activity.this, "请检查网络是否正常");
                try {
                    throw e;
            ...
            public void onNext(VCodeBenan vCodeBenan) {
                if (vCodeBenan.getCode() == 1) {
                    ...
                    UploadManage.INSTANS.upload(picBean, potions, vCodeBenan, CreateReqUploadData_1_Activity.this);
                }
            }
        });
    }
    ...
    public void showDialog() {
        ...
        if((picList!=null&&picList.size()==0)||picList==null){
            ...
            mSourceSubmitDialog.setMyClick(!CustomUtils.getPic(picList),false,!CustomUtils.getMusic(picList),false,!CustomUtils.getPic(picList));
        }
    ...
    private void showMenu(int type) {
        ...
        if (type == 0) {
            ...
            Intent intent = new Intent(CreateReqUploadData_1_Activity.this, ImageGridActivity.class);
            startActivityForResult(intent, IMAGE_PICKER);
        }
    }
    ...
    public void complete(String key, ResponseInfo info, JSONObject res, PicBean picBean) {
        ...
        Logger.d("qiniu: " + key + ",\r\n " + info + ",\r\n " + res);
        LogUtil.d(res+"各种信息:"+info+"：上传成功："+key);
    }
