...
public class AddPicAdater_1 extends DragAdapater<AddPicAdater_1.MyViewHolder> implements Constant {
    ...
    public AddPicAdater_1(Context context, List<PicBean> picBeanList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        if (picBeanList.get(position) != null) {
            ...
            //if (picBeanList.get(position).getProgress() == 100 || picBeanList.get(position).getType() == 0 || picBeanList.get(position).isVideo()) {
            ...
            if (null != onPicChangeListion) {
                ...
                if (picBeanList.get(position).getType() == 1) {
                    if (picBeanList.get(position).isVideo()) {
                    ...
                    } else if(picBeanList.get(position).isPic()){
                        ...
                        Glide.with(context)
                                ...
                                .into(holder.pic);
                    }else if(picBeanList.get(position).isMusic()){
                        LogUtil.d("有一个是音乐文件");
                        Glide.with(context)
                                .load("")
                                // .placeholder(R.mipmap.icon_dengru_touxiang)
