...
public class ToBeTerminalerActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_be_terminaler);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.save_button_ll:
                startActivityForResult(new Intent(ToBeTerminalerActivity.this, ToBeTerminalerActivity2.class), TERMINALER_REQUEST_RESULT);
                break;
        }
    }
