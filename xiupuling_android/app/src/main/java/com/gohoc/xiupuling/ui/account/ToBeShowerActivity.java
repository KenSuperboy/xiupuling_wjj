...
public class ToBeShowerActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_be_shower);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.save_button_ll:
                startActivityForResult(new Intent(ToBeShowerActivity.this,ToBeShowerActivity2.class),TERMINALER_REQUEST_RESULT);
                break;
        }
    }
