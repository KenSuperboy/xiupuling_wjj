...
public class ToBeTerminalerActivity5 extends BasicActivity {
    ...
    private Integer[] pics = {R.mipmap.img_jizhutrquanjieshao_1, R.mipmap.img_jizhutrquanjieshao_2, R.mipmap.img_jizhutrquanjieshao_3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_to_be_terminaler5);
        ButterKnife.bind(this);
        setStatusColor(R.color.colorPrimary);
        toolbarTitle.setText("成为机主");
    ...
    private void applyforjz() {
        RxRetrofitClient.getInstance(this).applyforjz(new Observer<VCodeBenan>() {
            @Override
            ...
            public void onError(Throwable e) {
                Utils.toast(ToBeTerminalerActivity5.this, "请检查网络是否正常");
                try {
                    throw e;
            ...
            public void onNext(VCodeBenan vCodeBenan) {
                Utils.toast(ToBeTerminalerActivity5.this, vCodeBenan.getMessage());
                if (vCodeBenan.getCode() == 1) {
                    Credential.getInstance().updateUserInfo(ToBeTerminalerActivity5.this);
                    setResult(RESULT_OK);
                    finish();
                }
            }
