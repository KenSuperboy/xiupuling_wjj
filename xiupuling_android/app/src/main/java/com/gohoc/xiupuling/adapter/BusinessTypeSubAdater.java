...
public class BusinessTypeSubAdater extends RecyclerView.Adapter<BusinessTypeSubAdater.MyViewHolder> {

    private Context context;
    private BusinessTypeBean businessBean;
    private OnItemClickLitener onItemClickLitener;

    public BusinessTypeSubAdater(Context context, BusinessTypeBean businessBean) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.item_simple_menu, parent,
                false));
        return holder;
    }
