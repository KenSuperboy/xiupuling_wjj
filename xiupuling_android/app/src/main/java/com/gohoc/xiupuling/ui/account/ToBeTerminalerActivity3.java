...
public class ToBeTerminalerActivity3 extends BasicActivity {
    ...
    private Integer[] pics = {R.mipmap.img_jizhutrquanjieshao_2};
    private static int TERMINALER_REQUEST_RESULT = 1000;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_to_be_terminaler3);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.save_button_ll:
               startActivityForResult(new Intent(ToBeTerminalerActivity3.this, ToBeTerminalerActivity4.class),TERMINALER_REQUEST_RESULT);
                break;
        }
    }
